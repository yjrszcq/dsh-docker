  ...
  return h(React.Fragment, null,
    ...
    h('section', { className: css.section, 'aria-labelledby': 'platform-proxy-title' },
      ...
      advanced ? h('div', { className: css.proxyAdvanced },
        ...
        h('label', { className: css.proxyDirectRulesField }, h('textarea', { rows: 5, value: directRulesText, spellCheck: false, 'aria-label': t('proxyDirectRules'), placeholder: t('proxyDirectRulesPlaceholder'), onChange: event => setDirectRulesText(event.target.value) }), h('small', null, t('proxyDirectRulesDetail'))),
        h('div', { className: `${css.proxySettingRow} ${css.proxyAdvancedSetting}` },
          ...
          h('label', { className: css.toggle, 'aria-label': t('proxyAllProxy'), ...toggleScrollHandlers }, h('input', { type: 'checkbox', checked: connection.allProxy, onChange: event => preserveToggleScroll(event.currentTarget, () => patchConnection(['allProxy'], event.target.checked)) }), h('span', { 'aria-hidden': true }))),
          ...
          h('div', { className: css.proxyProviderControls },
            ...
            h('label', { className: css.toggle, 'aria-label': displayName, ...toggleScrollHandlers },
              h('input', {
                ...
                disabled: provider.routingCapability === 'forced-direct',
