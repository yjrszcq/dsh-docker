    ...
    h('section', { className: css.section, 'aria-labelledby': 'platform-proxy-title' },
      ...
      advanced ? h('div', { className: css.proxyAdvanced },
        ...
        h('div', { className: `${css.proxySettingRow} ${css.proxyAdvancedSetting}` },
          ...
          h('label', { className: css.toggle, 'aria-label': t('proxyAllProxy'), ...toggleScrollHandlers }, h('input', { type: 'checkbox', checked: connection.allProxy, onChange: event => preserveToggleScroll(event.currentTarget, () => patchConnection(['allProxy'], event.target.checked)) }), h('span', { 'aria-hidden': true })))) : null,
