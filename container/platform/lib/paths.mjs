...
export class PlatformPaths {
  constructor(dataRoot = '/data/platform', runRoot = '/run/dsh-platform') {
    ...
    this.accessStateRoot = join(this.stateRoot, 'access')
    ...
    this.accessRunRoot = join(this.runRoot, 'access')
    this.accessSocket = join(this.accessRunRoot, 'access.sock')
    this.accessRecoverySocket = join(this.accessRunRoot, 'recovery.sock')
    this.accessLaunchSocket = join(this.runRoot, 'access-launch.sock')
