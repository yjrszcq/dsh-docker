...
import { MetadataClient, NpmRegistryClient } from '../../components/updater/lib/metadata.mjs'
import { TargetPreparer } from '../../components/updater/lib/preparer.mjs'
import { UpdateCoordinator } from '../../components/updater/lib/coordinator.mjs'
import { UpdateScheduler } from '../../components/updater/lib/scheduler.mjs'
import { UpdateStateStore } from '../../components/updater/lib/state.mjs'
import { PlatformActivator } from '../../components/updater/lib/activator.mjs'
import { UpdateJournal } from '../../components/updater/lib/journal.mjs'
import { PersistentStateSnapshots } from '../../components/updater/lib/snapshots.mjs'
import { reconcileRecoveredState } from '../../components/updater/lib/recovery.mjs'
import { ChannelStateStore } from '../../components/updater/lib/channel-state.mjs'
