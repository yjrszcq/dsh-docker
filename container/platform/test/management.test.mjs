...
test('standalone console keeps localized feature parity on the shared Management API', async () => {
  ...
  assert.match(script, /authCurrentPasswordPlaceholder: '请输入当前主密码以确认修改'/)
  assert.match(script, /authCurrentPasswordPlaceholder: 'Enter the current main password to confirm changes'/)
