...
test('Platform Management is embedded in the official settings.section slot', async () => {
  ...
  assert.match(source, /\['maintenance', 'plugins', 'skills', 'authentication', 'proxy', 'updates'\]/)
  ...
  assert.match(source, /\['maintenance', 'plugins', 'skills', 'authentication', 'proxy', 'updates'\]\.map/)
