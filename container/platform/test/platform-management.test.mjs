...
test('Platform Management follows DSH settings tokens and responsive layout', async () => {
  ...
  assert.match(style, /\.logResizeFrame \{[\s\S]*height: 280px;[\s\S]*min-height: 140px;[\s\S]*max-height: min\(720px, 70dvh\);/)
  ...
  assert.match(style, /@media \(max-width: 640px\)[\s\S]*\.logResizeFrame \{ height: min\(260px, 36dvh\); \}/)
