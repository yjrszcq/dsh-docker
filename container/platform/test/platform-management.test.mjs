...
test('Platform Management is embedded in the official settings.section slot', async () => {
  ...
  assert.match(source, /updatesTab: '更新', automaticTab: '自动检查', maintenanceTab: '运行维护'/)
  assert.match(source, /updatesTab: 'Updates', automaticTab: 'Auto checks', maintenanceTab: 'Runtime'/)
