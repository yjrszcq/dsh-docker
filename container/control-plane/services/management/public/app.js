...
const COPY = Object.freeze({
  zh: Object.freeze({
    ...
    systemPlugins: '系统插件', systemPluginsConsoleDetail: '管理当前环境提供的所有系统插件，也可恢复 DSH 中的管理中心集成。',
    noSystemPlugins: '当前环境没有提供系统插件。', managementIntegration: 'DSH 管理中心集成，可从此独立页面恢复。',
  ...
  en: Object.freeze({
    ...
    systemPlugins: 'System plugins', systemPluginsConsoleDetail: 'Manage every bundled System Plugin, including recovery of the DSH Management Console integration.',
    noSystemPlugins: 'The current Environment provides no System Plugins.', managementIntegration: 'DSH Management Console integration, recoverable from this standalone page.',
