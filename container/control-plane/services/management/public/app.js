...
const COPY = Object.freeze({
  zh: Object.freeze({
    title: 'DSH 管理中心', consoleLabel: '独立管理控制台', returnDsh: '返回 DSH',
  ...
  en: Object.freeze({
    title: 'DSH Management Console', consoleLabel: 'Standalone console', returnDsh: 'Return to DSH',
...
async function confirmTotpEnrollment() {
  ...
  try {
    ...
    renderAuthenticationAccountSaveState()
    showAuthenticationStatus(t('authTotpConfirmedDraft'))
  } catch (error) {
...
elements['auth-totp-enabled'].addEventListener('change', () => { void changeTotpEnabled() })
