...
const COPY = Object.freeze({
  zh: Object.freeze({
    ...
    proxyTitle: '代理设置', proxyDetail: '为选定的出站流量使用已有的 HTTP 或 SOCKS5 代理。', proxyAdvanced: '高级', proxyUnsaved: '未保存', proxySavedShort: '已保存', proxyReadyShort: '已就绪', proxyUnavailableShort: '不可用', proxyProtocol: '协议', proxyHost: '主机', proxyPort: '端口', proxyUsername: '用户名', proxyPassword: '密码', proxyPasswordPlaceholder: '留空表示保留已有密码', proxyRemoteDns: '通过 SOCKS5 解析目标 DNS', proxyRemoteDnsDetail: '避免在容器内解析目标域名。', proxyClearPassword: '清除密码', proxyTransportWarning: '当前页面未使用 HTTPS，代理凭据仅受现有网络边界保护。', proxyComponentReady: '出站代理组件已就绪', proxyComponentUnavailable: '出站代理组件暂不可用',
...
function renderProxyConfiguration() {
  ...
  elements['proxy-component-state'].textContent = t(configuration.componentReady ? 'proxyReadyShort' : 'proxyUnavailableShort')
  elements['proxy-component-state'].dataset.state = configuration.componentReady ? 'ready' : 'unavailable'
