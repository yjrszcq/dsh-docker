...
test('bounded management and Console requests use the protected local socket instead of DSH upstream', async () => {
  ...
  try {
    ...
    for (const [method, path] of [
      ...
      ['POST', '/_dsh_platform/api/v1/auth-totp/disable-confirmations'],
      ['POST', '/_dsh_platform/api/v1/auth-totp/disable-confirmations/confirm'],
      ['POST', '/_dsh_platform/api/v1/auth-totp/disable-confirmations/cancel'],
